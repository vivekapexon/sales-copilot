  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-connection": {
          "0%, 100%": { strokeOpacity: "1", strokeDasharray: "0 10" },
          "50%": { strokeOpacity: "0.5", strokeDasharray: "5 5" },
        },
        "node-glow": {
      ...
      animation: {
        ...
        "ibm-pulse": "ibm-pulse 3s ease-in-out infinite",
      },
    },
  },
